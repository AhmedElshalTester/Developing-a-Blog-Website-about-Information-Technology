...
<nav class="navbar navbar-inverse" role="navigation">
	...
	<a class="navbar-brand" href="Blog.php">
	   <img style="margin-top: -15px;" src="images/1.PNG" width=192;height=30;>
	</a> 
		</div>
...
<div class="container"> <!--Container-->
	<div class="blog-header">
     <h1>Kafrelsheikh University</h1>   
        <p class="lead">Faculty of Computers and Information</p>
	<p class="lead">Software Engineering Department</p>
       <!-- <p class="lead">Amr Abohany</p>
        <p class="lead">Lecturer at Information System Dept</p> -->
...
<?php } ?>
	...
	if(isset($Page))
	{
		...
		<div class="col-sm-offset-1 col-sm-3"> <!--Side Area -->
			<h2>About me </h2>
	<img class=" img-responsive img-circle imageicon" src="images/friend2.jpg">		
		<p>Software Engineering Students,Our Bio
            We have a passion for innovation and entrepreneurship
            in software engineering & information technology.</p>
...
<div id="Footer">
<hr><p>Theme By | Software Engineering Students |&copy;2018-2019 --- All right reserved.
</p>
<a style="color: white; text-decoration: none; cursor: pointer; font-weight:bold;" href="https://developer.ibm.com/africa/skills/artificial-intelligence/" target="_blank">
<p>
This Blog show articles about data science field such as Deep Learning & Artificial Intelligence & Internet of Things & Machine Learning and Big Data. <br>&trade; IBM Digital Nation Africa &trade;  IBM ; &trade; Skill Overview
 ; &trade; My Badges</p><hr>
</a>
